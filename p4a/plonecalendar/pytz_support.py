...
# This file is copied from what will be Zope 2.11, and should only
# be imported conditionally, after trying to import it from 
# DateTime. When 2.10 supoprt is no longer needed, it can be removed.
    ...
    def __getitem__(self, key):
        ...
        try:
            ...
            try:
                ...
                raise ValueError,'Unrecognized timezone: %s' % key